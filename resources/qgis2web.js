...
map.getView().fit([368303.505693, 8254061.994986, 799301.099013, 8603273.900417], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa del departamento de Ayacucho</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (105 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado por el curso de Cartografia y SIG<br />UPN 2025<br />Ing.Angheli Geraldine Carrion Rosales ';
            }
